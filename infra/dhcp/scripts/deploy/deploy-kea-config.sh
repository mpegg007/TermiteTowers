...
#  %ccm_git_branch: dev1 %
#  %ccm_git_object_id: infra/dhcp/scripts/deploy/deploy-kea-config.sh:121 %
#  %ccm_git_author: mpegg %
#  %ccm_git_author_email: mpegg@hotmail.com %
#  %ccm_git_blob_sha: afa0bdd1c5bbe5b8327e04b41876739a158214d0 %
...
#  %ccm_git_modify_date: 2025-11-30 12:26:10 %
#  %ccm_git_file_last_modified: 2025-11-30 12:26:10 %
#  %ccm_git_file_name: deploy-kea-config.sh %
#  %ccm_git_path: infra/dhcp/scripts/deploy/deploy-kea-config.sh %
...
# %git_commit_history: comment block updates % 
# %git_commit_history: service updates % 

# KEA DHCP Configuration Deployment Script
...
CONFIG_FILE="$PROJECT_ROOT/configs/kea/tt-kea-dhcp4-dev1.conf"
LOG_FILE="$PROJECT_ROOT/logs/deployment.log"

# Default DHCP server settings (override in dhcp-servers.conf)
DHCP_SERVERS="${DHCP_SERVERS:-}"
DHCP_USER="${DHCP_USER:-dhcp-admin}"
DHCP_CONFIG_PATH="${DHCP_CONFIG_PATH:-/etc/kea/tt-kea-dhcp4-dev1.conf}"
DHCP_SERVICE_NAME="${DHCP_SERVICE_NAME:-kea-dhcp4.service}"
