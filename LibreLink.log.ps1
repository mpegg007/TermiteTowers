...
# % ccm_branch: main %
# % ccm_object_id: LibreLink.log.ps1:59 %
...
# % ccm_file_eol: CRLF %
# % ccm_path: LibreLink.log.ps1 %
# % ccm_blob_sha: 986c08a85db5e2a7c746b9504136abf50be5b4b1 %
# % ccm_exec: no %
# % ccm_size: 1074 %
# % ccm_tag:  %
...
$target = Join-Path $PSScriptRoot 'health/libre/LibreLink.log.ps1'
if (Test-Path $target) {
