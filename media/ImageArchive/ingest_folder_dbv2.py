...
#  %ccm_git_branch: dev1 %
#  %ccm_git_object_id: media/ImageArchive/ingest_folder_dbv2.py:149 %
#  %ccm_git_author: mpegg %
#  %ccm_git_author_email: mpegg@hotmail.com %
#  %ccm_git_blob_sha: 82757a5eb0a497c88055608161cf8a1fec1d2d2e %
...
#  %ccm_git_file_last_modified: 2026-06-18 16:20:29 %
#  %ccm_git_file_name: ingest_folder_dbv2.py %
#  %ccm_git_path: media/ImageArchive/ingest_folder_dbv2.py %
...
def get_all_tags(filepath: str) -> dict:
    raw = run_et("-j", "-a", "-G1", "-d", "%Y-%m-%d %H:%M:%S%z", filepath)
    try:
